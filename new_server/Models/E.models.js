...
max(case when f2.m=match.match_id and ((toss_name='bat' and toss_winner!=match_winner) or (toss_name='field' and toss_winner=match_winner)) then f1.m else -1 end) as chase
