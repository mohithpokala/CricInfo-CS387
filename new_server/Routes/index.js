...
const {bat_stats,bowl_stats,misc_info,umpire_info,player_info,summary,matches_info,match_info,comp} = require('../Controllers');
...
routes.get('/scorecard/bowl_stats/:match_id/:innings_number',comp);
